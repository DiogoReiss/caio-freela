...
const IndexPage = () => (
  <Layout title="its the landing page caio malaco">
    ...
    >
      ...
      />
      <div className="flex w-10/12 md:w-4/12 h-20 rounded-md text-branco bg-azulEscuro text-center self-center justify-center mt-6 hover:bg-azulClaro transition duration-150 ease-in-out cursor-pointer">
        <a href="" className="font-bold text-2xl md:text-4xl place-self-center">
          ME INSCREVER
        </a>
      </div>
        ...
        <div className="flex flex-col md:flex-row ">
          <div className="flex order-last flex-col md:order-none">
            ...
            <p className="text-laranja font-medium md:text-2xl w-full order-last md:order-none md:w-11/12 mt-6">
              ...
              loja virtual e criei <strong></strong>, hoje tenho uma loja física
              e sigo ampliando minhas vendas através do virtual, essa estratégia
              me trouxe <strong>mais de 6 dígitos de faturamento</strong>. Em
              Abril de 2021, eu decidi levar minha estratégia para mais pessoas
              e <strong>revelar todo o meu processo de vendas</strong>, geração
